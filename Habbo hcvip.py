...
async def sofahc(ctx,  keko1, keko2):
    ...
    await ctx.send("Generando sofa vip diamante...", delete_after=0)
    time.sleep(3)
    ...
    trozoSOFAHC = Image.open(r"imagenes/TrozoHCSofaDiamante.png").convert("RGBA")
    img1 = trozoSOFAHC.resize((200,135), Image.ANTIALIAS)#tamaño del trozo de sofa
    
    img1 = Image.open(r"imagenes/HCSofaDiamante.png").convert("RGBA") #Imagen del sofa habbo club
